...
function VehiclesTab({vehicles,tasks,employees,clients,defaultRate,onUpdateVehicle}) {
  ...
  return (<div>
    ...
    {inProgress.length===0
      ?<div style={{textAlign:"center",padding:"32px 0",color:B.gray400,marginBottom:24}}>
    ...
    <div style={{borderTop:`1px solid ${B.gray700}`,paddingTop:16}}>
      ...
      {showDelivered&&(delivered.length===0
        ?<div style={{textAlign:"center",padding:"20px 0",color:B.gray400,fontSize:13}}>Nenhum veículo entregue ainda.</div>
        :<div style={{display:"flex",flexDirection:"column",gap:10}}>
...
function VehicleHistoryCard({vehicle,tasks,employees,clients,defaultRate,onUpdateVehicle,now}) {
  ...
  const workElapsed = workMs > 0 ? elapsedTime(new Date(Date.now() - workMs).toISOString(), Date.now()) : null;
