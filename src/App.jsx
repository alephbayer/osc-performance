...
export default function App() {
  ...
  return (<div key={theme} style={{position:"fixed",top:0,left:0,right:0,bottom:0,overflow:"hidden",background:B.black,fontFamily:"'Inter','Segoe UI',sans-serif",color:B.white,display:"flex"}}>
