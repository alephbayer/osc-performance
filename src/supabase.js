...
const mapTaskIn = (t) => ({
  ...
  fromStock: t.from_stock,
  stockItemId: t.stock_item_id,
});
const mapTaskOut = (t) => ({
...
export const db = {
  ...
  async updateTask(id, patch) {
    const dbPatch = {};
    const map = { vehicleId:"vehicle_id", label:"label", done:"done", material:"material", materialCost:"material_cost", hours:"hours", ratePerHour:"rate_per_hour", fromStock:"from_stock", stockItemId:"stock_item_id" };
